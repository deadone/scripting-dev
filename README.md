...
- <B>py2bof-winx86-template.py</B> - python2 buffer overflow template made for quick windows x86 exploitation<br>
- <B>py3bof-winx86-template.py</B> - python3 buffer overflow template made for quick windows x86 exploitation<br>
